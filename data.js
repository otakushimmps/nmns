...
const ctConfig = [
  {
    ...
    count: 1,
    tableRows: [
      { label: "冷卻能力", value: "7,255 kW (27 m³/sec 空氣流量)" },
      { label: "風量 (CMM)", value: "33,600 CMM" },
      { label: "塔體", value: "FRP 塔體 + 鍍鋅鋼構支撐" },
      { label: "填料 (Fill)", value: "PVC 對齊板，符合 ASTM E84 不燃" },
      { label: "消霧器", value: "三層除霧器，漂水率 < 0.7%" },
      { label: "風機", value: "IE4 全密閉風扇冷卻電機" },
      { label: "噪音", value: "距離 1.5 m ≤ 70 dBA" }
    ],
    spec: {
      "冷卻能力": "7,255 kW (27 m³/sec 空氣流量)",
      "風量 (CMM)": "33,600 CMM",
      "塔體": "FRP 塔體 + 鍍鋅鋼構支撐",
      "填料 (Fill)": "PVC 對齊板，符合 ASTM E84 等級",
      "消霧器": "三層除霧器，漂水率 < 0.7%",
      "風機": "IE4 全密閉風扇冷卻電機",
      "噪音標準": "距離 1.5 m ≤ 70 dBA"
    },
    checkTable: [
      { item: "TAB 平衡", detail: "進出水流量控制在 ±10%" },
      { item: "Fill + 消霧器", detail: "安裝平整、無裂痕、符合防火" },
      { item: "風機/減速機", detail: "正轉、振動、皮帶張力、軸封檢查" },
      { item: "補給水/溢流", detail: "管路密閉、無滲漏" },
      { item: "BEMS/Modbus", detail: "可讀出水溫/風量，60 秒更新一次" },
      { item: "水位控制", detail: "低/高水位自動化且警報正常" },
      { item: "噪音/漂水", detail: "≤70 dBA 且無飛霧" }
    ],
    checks: [
      "銘牌規格與設計相符",
      "控制系統 TAB 衡量進出水流量與設計值差異在 ±10%",
      "Fill 與消霧器安裝平整，符合防火",
      "風機振動/軸封/皮帶檢查",
      "補給水浮球閥與溢流管路連線完整",
      "BEMS/Modbus 可讀出水溫/風量資料",
      "低/高水位自動化功能與警報正常",
      "噪音與漂水測試符合規範"
    ]
  },
  {
    ...
    count: 1,
    tableRows: [
      { label: "冷卻能力", value: "5,441 kW (27 m³/sec)" },
      { label: "風量 (CMM)", value: "26,400 CMM" },
      { label: "塔體", value: "FRP + 鍍鋅鋼架" },
      { label: "填料", value: "PVC 對齊板" },
      { label: "消霧器", value: "三層排霧板" },
      { label: "風機", value: "IE4 全密閉" },
      { label: "噪音", value: "1.5 m ≤ 70 dBA" }
    ],
    spec: {
      "冷卻能力": "5,441 kW (27 m³/sec)",
      "風量 (CMM)": "26,400 CMM",
      "塔體": "FRP 塔體 + 鍍鋅鋼架",
      "填料 (Fill)": "PVC 對齊板",
      "消霧器": "三層排霧板",
    ...
    checkTable: [
      { item: "塔體支架", detail: "定位牢固、螺栓緊固" },
      { item: "Fill+消霧器", detail: "完好、清潔並記錄" },
      { item: "風機/減速機", detail: "振動值符合 ISO 10816" },
      { item: "水量平衡", detail: "進出水流量差異 < ±10%" },
      { item: "BEMS/水位", detail: "數據可讀且警報運作正常" },
      { item: "噪音/漂水", detail: "測試結果滿足規範" }
    ],
    checks: [
      "塔體結構與支架無裂縫，連接螺栓牢固",
      "填料與消霧器安裝平整並無堵塞",
      "風機/減速機/皮帶張力檢查，振動符合 ISO 10816",
      "溫度回路與水位控制可由 BEMS 監控",
      "水量平衡測試差異 < ±10%",
      "噪音、漂水與消霧效果符合驗收"
    ]
